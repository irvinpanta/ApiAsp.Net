...
using SisAvikar.Infrastructure.Data.Configurations;

#nullable disable

namespace SisAvikar.Infrastructure.Data
{
    public partial class SisAvikarDemoContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.ApplyConfigurationsFromAssembly(typeof(SisAvikarDemoContext).Assembly);
            modelBuilder.ApplyConfiguration(new SalonConfigurations());
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                ...
                entity.Property(e => e.Empleado1).HasColumnName("Empleado");
